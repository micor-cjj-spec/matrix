...
## 目标
根据 `docs/bus/fi/gl/005-internal-notice/003-cashflow-notice/` 下业务文档，输出现金流通知单场景的接口契约提示词，为前后端联调、测试与评审提供统一接口口径。
...
- 前端 API：`internalNoticeApi.fetchCashflowNotices / generateCashflowNotices`
