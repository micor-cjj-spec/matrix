...
## 目标
根据 `docs/bus/fi/gl/006-ledger-collaboration/004-subject-compare/` 下业务文档，输出科目余额对照场景的接口契约提示词，为前后端联调、测试与评审提供统一接口口径。
...
3. 输出 `rows` 的结构与借贷/余额差异统计口径说明
4. 输出跳转到科目余额表页面的参数映射说明
