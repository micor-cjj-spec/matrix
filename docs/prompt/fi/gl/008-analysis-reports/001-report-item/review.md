...
## 目标
根据 `docs/bus/fi/gl/008-analysis-reports/001-report-item/` 下业务文档、当前 prompt 文档，以及已确认实现，输出报表项目场景的一致性评审提示词。
...
2. 检查模板、项目编码、项目名称、行次、层级、行类型、期间模式、可下钻、排序口径是否一致
3. 检查初始化自动查询、查询、刷新、分页展示是否一致
