...
public class PurchaseInboundInboxFailureRecorder {
    ...
    public void record(String rawJson, String messageId, Throwable throwable) {
        ...
        try {
            ...
            // malformed payload is still recorded with a synthetic event id and an empty JSON snapshot.
        }
        ...
        repository.recordInboxFailure(
                IdWorker.getId(), consumerCode, eventId, tenantId, orgId, eventType, safeJson, error);
    }
}
