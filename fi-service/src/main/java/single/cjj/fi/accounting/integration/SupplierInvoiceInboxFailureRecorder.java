...
public class SupplierInvoiceInboxFailureRecorder {
    ...
    public void record(String rawJson, String messageId, Throwable throwable) {
        ...
        try {
            ...
            // keep a recoverable failure record even when the message payload itself is malformed.
        }
