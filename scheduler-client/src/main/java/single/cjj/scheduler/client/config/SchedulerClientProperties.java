...
public class SchedulerClientProperties {
    ...
    public String getExecutorCode() { return executorCode; }
    public void setExecutorCode(String executorCode) { this.executorCode = executorCode; }
    ...
    public String requiredInternalToken() {
        if (internalToken == null || internalToken.isBlank()) {
            throw new IllegalStateException("matrix.scheduler.client.internal-token 不能为空");
        }
